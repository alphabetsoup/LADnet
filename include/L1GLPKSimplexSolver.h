...
#ifndef _L1GLPKSIMPLEXSOLVER_H_
#define _L1GLPKSIMPLEXSOLVER_H_


#include "global.h"
#include "L1GLPKIPSolver.h"

class L1GLPKSimplexSolver : public L1GLPKIPSolver {
    public:
    L1GLPKSimplexSolver(MeasSegment * seg, int segID, std::ostream& logs);
