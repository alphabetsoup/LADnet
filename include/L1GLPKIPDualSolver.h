...
#ifndef _L1GLPKDUALIPSOLVER_H_
#define _L1GLPKDUALIPSOLVER_H_
...
class L1GLPKIPDualSolver : public L1Solver {
    public:
    L1GLPKIPDualSolver(MeasSegment * seg, int segID, std::ostream& logs);
    ~L1GLPKIPDualSolver();
