...
#ifndef _L1GLPKSIMPLEXDUALSOLVER_H_
#define _L1GLPKSIMPLEXDUALSOLVER_H_


#include "global.h"
#include "L1GLPKIPDualSolver.h"

class L1GLPKSimplexDualSolver : public L1GLPKIPDualSolver {
    public:
    L1GLPKSimplexDualSolver(MeasSegment * seg, int segID, std::ostream& logs);
