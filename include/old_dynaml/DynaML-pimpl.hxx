...
protected:
  // because we need polymorphism, no auto_ptr.
  ::std::auto_ptr<DnaMeasurement_Struct> _m;
  DnaMeasurement* _child;
  bool haschild;
};
...
class DnaStation_pimpl: public virtual DnaStation_pskel, public UsesMeasNetwork
{
  ...
  virtual void
  StationCoord (const ::std::map<::std::string,::std::string>&);
...
class StationCoord_pimpl: public virtual StationCoord_pskel
{
  ...
  post_StationCoord ();
protected:
  ::std::map<::std::string,::std::string> _stncoord;
};
