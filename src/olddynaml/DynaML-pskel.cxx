...
void DnaStation_pskel::
StationCoord (const ::std::map<string,string>&)
{
}
  ...
  switch (state)
  {
    ...
    case 10UL:
    {
      ...
      else
      {
        if (this->Directions_parser_)
        {
          ::Directions& tmp (this->Directions_parser_->post_Directions ());
          this->Directions (tmp);
        }
    ...
    case 12UL:
    {
      ...
      else
      {
        if (this->GPSBaseline_parser_)
        {
          ::GPSBaseline& tmp (this->GPSBaseline_parser_->post_GPSBaseline ());
    ...
    case 16UL:
    {
      ...
      else
      {
        if (this->Clusterpoint_parser_)
        {
          ::YCluster& tmp (this->Clusterpoint_parser_->post_Clusterpoint ());
    ...
    case 3UL:
    {
            ...
            ns, n, "", "StationCoord", t))
      {
        ...
        else
        {
          if (this->StationCoord_parser_)
          {
            const ::std::map<string,string>& tmp (this->StationCoord_parser_->post_StationCoord ());
