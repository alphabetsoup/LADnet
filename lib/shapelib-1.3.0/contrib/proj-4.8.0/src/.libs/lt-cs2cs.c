...
/* ./.libs/lt-cs2cs.c - temporary wrapper executable for .libs/cs2cs.exe
   Generated by libtool (GNU libtool) 2.4

   The cs2cs program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "cs2cs.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cs2cs - temporary wrapper script for .libs/cs2cs.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The cs2cs program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"cs2cs.exe:cs2cs:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"cs2cs.exe:cs2cs:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"cs2cs.exe:cs2cs:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
