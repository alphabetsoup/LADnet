...
/* ./.libs/lt-nad2bin.c - temporary wrapper executable for .libs/nad2bin.exe
   Generated by libtool (GNU libtool) 2.4

   The nad2bin program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "d:\\L1All\\Libraries\\shapelib-1.3.0\\contrib\\proj-4.8.0\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\L1All\\Libraries\\shapelib-1.3.0\\contrib\\proj-4.8.0\\src\\.libs;C:\\MSYS-20111123\\msys\\local\\lib;C:\\MSYS-20111123\\msys\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "nad2bin.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# nad2bin - temporary wrapper script for .libs/nad2bin.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The nad2bin program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libproj.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"nad2bin.exe:nad2bin:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"nad2bin.exe:nad2bin:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"nad2bin.exe:nad2bin:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/L1All/Libraries/shapelib-1.3.0/contrib/proj-4.8.0/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/L1All/Libraries/shapelib-1.3.0/contrib/proj-4.8.0/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
